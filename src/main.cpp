...
#if defined(NDEBUG)
# error "Impleum cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Impleum Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
                ...
                if(nBestHeight <= 1000)
                {
                ...
                else if(nBestHeight <= 7200)
                 {
                     nSubsidy = nSubsidy * 500 ;  //500%
                 }

                    else if(nBestHeight <= 14400)
                 {
                     nSubsidy = nSubsidy * 250 ;  //250%
                 }

                    else if(nBestHeight <= 21600)
                 {
                     nSubsidy = nSubsidy * 500;  //500%
                 }

                    else if(nBestHeight <= 28800)
                 {
                     nSubsidy = nSubsidy * 250 ;  //250%
                 }

                    else if(nBestHeight <= 32400)
                 {
                    ...
                    else if(nBestHeight <= 36000)
                 {
                    ...
                    else if(nBestHeight <= 43200)
                 {
                     nSubsidy = nSubsidy * 250 ;  //250%
                 }

                 else if(nBestHeight <= 50400)
                 {
                     nSubsidy = nSubsidy * 500 ;  //500%
                 }

                 else if(nBestHeight <= 57600)
                 {
                     nSubsidy = nSubsidy * 250 ;  //250%
                 }
                 ...
                 else if(nBestHeight <= 75600)
                 {
                     nSubsidy = nSubsidy * 500 ;  //500%
                 }

                  else if(nBestHeight <= 82800)
                 {
                     nSubsidy = nSubsidy * 250 ;  //250%
                 }
                ...
                else if(nBestHeight <= 200400)
                {
                    return ((48/10) * COIN) + nFees;
                }
                 else
                {
...
bool CBlock::AcceptBlock()
{
    ...
    int64_t val = FutureDrift((int64_t)vtx[0].nTime, nHeight);
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    else if (strCommand == "addr")
    {
        ...
        addrman.Add(vAddrOk, pfrom->addr, 10000 * 60 * 60);
        if (vAddr.size() < 1000)
